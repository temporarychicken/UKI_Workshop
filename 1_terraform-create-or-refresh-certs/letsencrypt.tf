...
resource "acme_certificate" "certificate" {
  ...
  common_name               = "*.workshop0001.axwaydemo.net"
...
resource "local_file" "crt" {
    ...
    filename = "../certs/workshop0001.axwaydemo.net.crt.pem"
}

resource "local_file" "key" {
    content     = acme_certificate.certificate.private_key_pem
    filename = "../certs/workshop0001.axwaydemo.net.key.pem"
}

resource "local_file" "issuer" {
    content     = acme_certificate.certificate.issuer_pem
    filename = "../certs/workshop0001.axwaydemo.net.issuer.pem"
}
